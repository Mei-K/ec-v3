  ...
  <header>
    <div class="container">
      ...
      <div class="header-right">
        ...
        <router-link to="/logoutUser" v-show="loginStatus">
          <i class="fas fa-sign-in-alt"></i>ログアウト
        </router-link>
        <router-link to="/loginUser" v-show="!loginStatus">
...
export default defineComponent({
  setup() {
    ...
    //現在のログインステータスを表す
    loginStatus.value = ref(store.getters.getLoginStatus);
    console.dir(JSON.stringify(loginStatus.value));
