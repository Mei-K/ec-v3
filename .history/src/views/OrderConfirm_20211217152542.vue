<template>
  <div class="top-wrap">
    ...
    <CartList v-on:totalPrice="getcalcTotalPricePlusTax"></CartList>
...
export default defineComponent({
  ...
  setup() {
    ...
    let getcalcTotalPricePlusTax = ref("");
    console.log("合計金額" + getcalcTotalPricePlusTax);

    /**
     * 注文する.
     */
    const USER_ID = store.getters.getLoginUserInfo;
    console.dir("userID" + JSON.stringify(USER_ID));
    // let order = async () => {
