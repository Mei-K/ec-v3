  ...
  <div class="container">
    ...
    <div class="row">
      <table class="striped">
        ...
        <tbody v-for="cartItem of cartList" v-bind:key="cartItem.id">
          <tr>
            <td class="cart-item-name">
              <div class="cart-item-icon">
                <img :src="cartList._item._imagePath" />
              </div>
              <span>{{ cartList._item._name }}</span>
            </td>
            <td>
...
export default defineComponent({
  setup() {
    ...
    console.dir("cartList:" + JSON.stringify(cartList));
