<template>
  <div class="top-wrap">
    ...
    <div class="order-confirm-delivery-info">
      ...
      <div class="row">
        <div class="error-msg">  {{ errorMsgMailAddress }}
        <div class="input-field">
      ...
      <div class="row">
         <div class="error-msg"> {{ errorMsgZipcode }}
        <div class="input-field">
      ...
      <div class="row">
      <div class="error-msg">    {{ errorMsgAddress }}
        <div class="input-field">
      ...
      <div class="row">
       <div class="error-msg">   {{ errorMsgTel }}
        <div class="input-field">
      ...
      <div class="row order-confirm-delivery-datetime">
        <div class="input-field">
      <div class="error-msg">      {{ errorMsgDate }}
